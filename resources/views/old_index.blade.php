        ...
        <td style="text-align:center">
            ...
            <table width=100%>
                <tr>
                    <td colspan='3'>
                        <p>
                            <img src="../../storage/app/public/pictures/dragon-small.png" style="float:left;height:200px" alt="Golden Dragon">
                            <img src="../../storage/app/public/pictures/dragon-small-flipped.png" style="float:right;height:200px" alt="Golden Dragon">
                        ...
                        <table style="margin:auto;font-size:20px;color:white" border="1px solid white">
                            <tr background="../../storage/app/public/pictures/menu_bg_gradient.png">
                                <td valign="middle">
